...
write.csv(outliers_up, "6_750_250_outliers_upregulated_DESeq2.csv", row.names = FALSE)

outliers_down <- setdiff(detected_down_DESeq2, meta_down)
write.csv(outliers_down, "6_750_250_outliers_downregulated_DESeq2.csv", row.names = FALSE)
...
venn.diagram(
  ...
  output = TRUE,
  filename = "DESEQ2_6_750_250_venn_upregulated.png",
  output.type = "png",
  imagetype = "png",
  resolution = 300
)
...
venn.diagram(
  ...
  output = TRUE,
  filename = "DESEQ2_6_750_250_venn_downregulated.png",
  output.type = "png",
  imagetype = "png",
  resolution = 300
)
