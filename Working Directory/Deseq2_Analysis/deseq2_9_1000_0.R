...
write.csv(outliers_up, "Working Directory/Output/deseq2_9_1000_0_outliers_upregulated.csv", row.names = FALSE)

outliers_down <- setdiff(detected_down_DESeq2, meta_down)
write.csv(outliers_down, "Working Directory/Output/deseq2_9_1000_0_outliers_downregulated.csv", row.names = FALSE)
...
write.csv(metrics_df, "Working Directory/Output/Metrics_deseq2_9_1000_0.csv", row.names = FALSE)