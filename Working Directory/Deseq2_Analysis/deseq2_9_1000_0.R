...
write.csv(outliers_up, "9_1000_0_outliers_upregulated_DESeq2.csv", row.names = FALSE)

outliers_down <- setdiff(detected_down_DESeq2, meta_down)
write.csv(outliers_down, "9_1000_0_outliers_downregulated_DESeq2.csv", row.names = FALSE)
