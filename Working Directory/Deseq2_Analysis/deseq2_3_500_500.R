...
write.csv(outliers_up, "3_500_500_outliers_upregulated_DESeq2.csv", row.names = FALSE)

outliers_down <- setdiff(detected_down_DESeq2, meta_down)
write.csv(outliers_down, "3_500_500_outliers_downregulated_DESeq2.csv", row.names = FALSE)
