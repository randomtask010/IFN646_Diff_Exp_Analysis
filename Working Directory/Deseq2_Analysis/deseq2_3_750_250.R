...
write.csv(outliers_up, "Working Directory/Output/deseq2_3_750_250_outliers_upregulated.csv", row.names = FALSE)

outliers_down <- setdiff(detected_down_DESeq2, meta_down)
write.csv(outliers_down, "Working Directory/Output/deseq2_3_750_250_outliers_downregulated.csv", row.names = FALSE)
...
write.csv(metrics_df, "Working Directory/Output/Metrics_deseq2_3_750_250.csv", row.names = FALSE)