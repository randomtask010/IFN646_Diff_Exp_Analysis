...
# Step 2: Load Dataset
count_data <- read.table("RAW data/6_1000_0.tsv", header=TRUE, row.names=1)
...
meta_data <- read.table("RAW data/6_1000_0_meta.tsv", header=TRUE, row.names=1)
...
write.csv(outliers_up, "Working Directory/Output/deseq2_6_1000_0_outliers_upregulated.csv", row.names = FALSE)

outliers_down <- setdiff(detected_down_DESeq2, meta_down)
write.csv(outliers_down, "Working Directory/Output/deseq2_6_1000_0_outliers_downregulated.csv", row.names = FALSE)
...
write.csv(metrics_df, "Working Directory/Output/Metrics_deseq2_6_1000_0.csv", row.names = FALSE)