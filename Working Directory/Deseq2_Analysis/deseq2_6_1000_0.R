...
# Step 2: Load Dataset
count_data <- read.table("6_1000_0.tsv", header=TRUE, row.names=1)
...
meta_data <- read.table("6_1000_0_meta.tsv", header=TRUE, row.names=1)
...
write.csv(outliers_up, "6_1000_0_outliers_upregulated_DESeq2.csv", row.names = FALSE)

outliers_down <- setdiff(detected_down_DESeq2, meta_down)
write.csv(outliers_down, "6_1000_0_outliers_downregulated_DESeq2.csv", row.names = FALSE)
...
venn.diagram(
  ...
  output = TRUE,
  filename = "DESEQ2_6_1000_0_venn_upregulated.png",
  output.type = "png",
  imagetype = "png",
  resolution = 300
)
...
venn.diagram(
  ...
  output = TRUE,
  filename = "DESEQ2_6_1000_0_venn_downregulated.png",
  output.type = "png",
  imagetype = "png",
  resolution = 300
)