...
# Step 2: Load Dataset
count_data <- read.table("6_500_500.tsv", header=TRUE, row.names=1)
...
meta_data <- read.table("6_500_500_meta.tsv", header=TRUE, row.names=1)
...
write.csv(outliers_up, "6_500_500_outliers_upregulated_DESeq2.csv", row.names = FALSE)

outliers_down <- setdiff(detected_down_DESeq2, meta_down)
write.csv(outliers_down, "6_500_500_outliers_downregulated_DESeq2.csv", row.names = FALSE)
...
venn.diagram(
  ...
  output = TRUE,
  filename = "DESEQ2_6_500_500_venn_upregulated.png",
  output.type = "png",
  imagetype = "png",
  resolution = 300
)
...
venn.diagram(
  ...
  output = TRUE,
  filename = "DESEQ2_6_500_500_venn_downregulated.png",
  output.type = "png",
  imagetype = "png",
  resolution = 300
)