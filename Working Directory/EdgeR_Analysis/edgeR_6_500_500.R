...
write.csv(outliers_up, "Working Directory/Output/edgeR_6_500_500_outliers_upregulated.csv", row.names = FALSE)
outliers_down <- setdiff(detected_down_edgeR, meta_down)
write.csv(outliers_down, "Working Directory/Output/edgeR_6_500_500_outliers_downregulated.csv", row.names = FALSE)
