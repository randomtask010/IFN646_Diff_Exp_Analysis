...
write.csv(outliers_up, "Working Directory/Output/edgeR_3_1000_0_outliers_upregulated.csv", row.names = FALSE)
outliers_down <- setdiff(detected_down_edgeR, meta_down)
write.csv(outliers_down, "Working Directory/Output/edgeR_3_1000_0_outliers_downregulated.csv", row.names = FALSE)
...
write.csv(metrics_df, "Working Directory/Output/Metrics_edgeR_3_1000_0.csv", row.names = FALSE)
