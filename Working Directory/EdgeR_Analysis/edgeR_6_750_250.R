...
write.csv(outliers_up, "Working Directory/Output/edgeR_6_750_250_outliers_upregulated.csv", row.names = FALSE)
outliers_down <- setdiff(detected_down_edgeR, meta_down)
write.csv(outliers_down, "Working Directory/Output/edgeR_6_750_250_outliers_downregulated.csv", row.names = FALSE)
...
write.csv(metrics_df, "Working Directory/Output/Metrics_edgeR_6_750_250.csv", row.names = FALSE)
