...
write.csv(outliers_up, "9_1000_0_outliers_upregulated.csv", row.names = FALSE)
outliers_down <- setdiff(detected_down_edgeR, meta_down)
write.csv(outliers_down, "9_1000_0_outliers_downregulated.csv", row.names = FALSE)
...
venn.diagram(
  ...
  output = TRUE,
  filename = "9_1000_0_venn_upregulated.png",
  output.type = "png",
  imagetype = "png",
  resolution = 300
)
...
venn.diagram(
  ...
  output = TRUE,
  filename = "9_1000_0_venn_downregulated.png",
  output.type = "png",
  imagetype = "png",
  resolution = 300
)
