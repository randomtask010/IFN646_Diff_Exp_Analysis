...
outliers_up
write.csv(outliers_up, "Working Directory/Output/noiseq_3_500_500_outliers_upregulated.csv", row.names = FALSE)
outliers_down <- setdiff(detected_down_NOISeq, meta_down)
write.csv(outliers_down, "Working Directory/Output/noiseq_3_500_500_outliers_downregulated.csv", row.names = FALSE)
