...
outliers_up
write.csv(outliers_up, "Working Directory/Output/noiseq_6_500_500_outliers_upregulated.csv", row.names = FALSE)
outliers_down <- setdiff(detected_down_NOISeq, meta_down)
write.csv(outliers_down, "Working Directory/Output/noiseq_6_500_500_outliers_downregulated.csv", row.names = FALSE)
...
write.csv(metrics_df, "Working Directory/Output/Metrics_noiseq_6_500_500.csv", row.names = FALSE)
