...
# Step 2: Load Dataset
count_data <- read.table("synthetic_data/6_750_250.tsv", header=TRUE, row.names=1)
...
meta_data <- read.table("synthetic_data/6_750_250_meta.tsv", header=TRUE, row.names=1)
meta_data
