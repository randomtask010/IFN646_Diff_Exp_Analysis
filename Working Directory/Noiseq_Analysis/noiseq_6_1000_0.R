...
outliers_up
write.csv(outliers_up, "Working Directory/Output/noiseq_6_1000_0_outliers_upregulated.csv", row.names = FALSE)
outliers_down <- setdiff(detected_down_NOISeq, meta_down)
write.csv(outliers_down, "Working Directory/Output/noiseq_6_1000_0_outliers_downregulated.csv", row.names = FALSE)
...
write.csv(metrics_df, "Working Directory/Output/Metrics_noiseq_6_1000_0.csv", row.names = FALSE)
